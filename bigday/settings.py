...
ALLOWED_HOSTS = ["my_website_url", "0.0.0.0", "127.0.0.1", "localhost", "192.168.1.182"]
...
BRIDE_AND_GROOM = 'Nic and Jack'
# the date of your wedding
WEDDING_DATE = 'June 20th, 2026'
# the location of your wedding
WEDDING_LOCATION = 'Victoria, BC'
# This is used in links in save the date / invitations
WEDDING_WEBSITE_URL = 'https://nicandjack.wedding'
